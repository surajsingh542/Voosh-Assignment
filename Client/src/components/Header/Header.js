            ...
            <div className="flex flex-wrap xl:items-center -mx-4">
              <div className="w-full md:w-1/2 px-4 mb-16 md:mb-0">
                <span className="inline-block py-px px-2 mb-4 text-xs leading-5 text-white bg-green-500 uppercase rounded-9xl">
                  Voosh Food Technologies
                </span>
                <h1 className="mb-6 text-3xl md:text-5xl lg:text-6xl leading-tight font-bold tracking-tight">
                  Grow Your Business on Third-Party Delivery Platforms
                </h1>
                <p className="mb-8 text-lg md:text-xl text-gray-500 font-medium">
                  Consolidated, Automated, Efficient: Voosh is your ultimate
                  restaurant partner for managing and growing your business on
                  DoorDash, Uber Eats, GrubHub, and More. Automatically recover
                  chargebacks, saving money and boosting profits. Through a
                  single dashboard, Voosh helps restaurants to save time, reduce
              ...
              <div className="w-full md:w-1/2 px-4">
                <div className="relative mx-auto md:mr-0 max-w-max">
                  <img
                    ...
                    src="https://www.handover.in/wp-content/uploads/The-Role-of-Delivery-Partner-in-Your-Business-Growth.jpeg"
                    alt="landing"
                  />
                </div>
              </div>
